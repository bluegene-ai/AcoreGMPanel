...
final class ModuleAssets
{
    ...
    private const NAV_ITEMS = [
        ...
        [
            'path' => '/character-boost',
            'label' => 'app.nav.character_boost',
            'activePrefixes' => ['/character-boost'],
            // 只要拥有执行直升或模板管理任一权限，就应该能看到这个入口
            'capability' => ['boost.apply', 'boost.templates', 'boost.codes'],
        ],
        [
            'path' => '/raf',
            'label' => 'app.nav.raf',
        ...
        [
            'path' => '/item-inventory',
            'label' => 'app.nav.item_inventory',
            'activePrefixes' => ['/item-inventory', '/bag', '/bag-query', '/item-ownership'],
    ...
    private const CSS_BUNDLES = [
        ...
        'aegis' => ['aegis'],
        'boss' => ['boss'],
        'character' => ['character', 'item_inventory'],
