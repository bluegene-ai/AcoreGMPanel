...
return [
    ...
    'intro_short' => 'Listings and market data, in-place config edits, policy tables and GM commands.',
    ...
    'master' => [
        ...
        'power_hint_short' => 'Writes this realm\'s options (survives a restart); other realms unaffected.',
    ...
    'settings' => [
        ...
        'restart_note_short' => 'A worldserver restart is required after saving.',
        'save' => 'Save configuration',
        'backup_note' => 'Only changed keys are written; untouched lines are left alone.',
        'backup_note_short' => 'Only changed keys are written.',
    ],
    'groups' => [
    ...
    'policy' => [
        ...
        'disabled_hint_short' => 'Items listed here are never auto-listed; effective within a minute.',
        'disabled' => 'Blacklist',
        'item_id' => 'Item id',
        'item_name' => 'Item name',
        ...
        'class_no_rows_short' => 'Not whitelisted, so never listed; set a quota and apply it to the class.',
    ...
    'actions' => [
        ...
        'runtime_hint_short' => 'Runtime memory only; a restart restores the file values.',
        'enable' => 'Enable',
        'disable' => 'Disable',
        ...
        'gm_hint_short' => 'Restock lists enabled pick-list rows; force-expire skips player entries by default.',
        ...
        'addlist_hint_short' => 'No owner override = each row\'s own owner; the bot recycles all gold.',
        ...
        'marketscan_hint_short' => 'Aggregates this realm\'s listings into per-unit prices; bot listings excluded.',
        ...
        'market_hint_short' => 'Import needs a CSV file in the configuration; prune drops scans past retention.',
