...
return [
    ...
    'show' => [
        ...
        // Tooltip for content names that deep-link into their management screen
        'manage_link' => [
            'item' => 'Open #:id in items management',
            'quest' => 'Open #:id in quests management',
        ],
        'quests' => [
            'title' => 'Quests',
